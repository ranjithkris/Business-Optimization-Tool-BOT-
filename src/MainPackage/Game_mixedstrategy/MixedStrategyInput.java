...
public class MixedStrategyInput extends JFrame{
	...
	static JButton bAbout = new JButton(("About Mixed Strategy"));
	...
	public MixedStrategyInput(int width,int height,int rowValue,int colValue)
        {
        ...
        catch(Exception e)
        {
            ...
            inputFrame.setTitle(("MIXED STRATEGY"));
                        ...
                        bCompute.addActionListener(new ActionListener()
    		{
                    ...
                    {	
                        try
                        {
                            ...
                            implementMixedStrategy.compute(strategy, row_value, col_value);
                            inputFrame.dispose();
                        }
                        catch(Exception evt)
                        {
    			...
    			public void actionPerformed(ActionEvent ae)
                        {
                            try {
                                    ...
                                    Logger.getLogger(MixedStrategyInput.class.getName()).log(Level.SEVERE, null, ex);
                                }
                        }
    		});
